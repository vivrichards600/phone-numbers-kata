...
Public Class PhoneNumberTests
    ...
    <TestMethod()>
    Public Sub Phone_Number_Must_Be_More_Than_1_Digit_In_Length()
        Assert.IsTrue(Validate.PhoneNumber("1") = INVALID_ERROR)
    End Sub
    ...
    <TestMethod()>
    Public Sub Phone_Number_Ignores_Special_Characters()
